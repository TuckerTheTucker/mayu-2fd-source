...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		levelInfo.setFormat(Paths.font("pm.ttf"), 32);
		...
		levelDifficulty.setFormat(Paths.font('pm.ttf'), 32);
		...
		perSongOffset.setFormat(Paths.font("pm.ttf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
