	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf-mayu':
				...
				animation.addByPrefix('secondDeath', "death2", 24, false);
				animation.addByPrefix('deathLoop', "deathLoop", 24, true);
				animation.addByPrefix('deathConfirm', "deathGo", 24, false);
			...
			case 'ren':
				tex = Paths.getSparrowAtlas('characters/ren');
				frames = tex;
				animation.addByPrefix('idle', 'idle', 24, false);
				animation.addByPrefix('singUP', 'ren up', 24, false);
				animation.addByPrefix('singDOWN', 'ren down', 24, false);
				animation.addByPrefix('singLEFT', 'ren left', 24, false);
				animation.addByPrefix('singRIGHT', 'ren right', 24, false);
